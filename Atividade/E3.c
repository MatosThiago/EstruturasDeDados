...
armazena o conteúdo do vetor no arquivo "data.bin", e o conteúdo da variável
N no arquivo "n.bin".
...
void printbin(T_funcionario* F, int N);
...
void printbin(T_funcionario* F, int N) {
    ...
    fwrite(F, sizeof(T_funcionario), N, file);
